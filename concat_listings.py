...
# end at the most recently completed calendar month
...
while (year < end_year) or (year == end_year and month <= end_month):
    listing_filename = f'{csv_dir}/CRMLSListing{year}{month:02d}.csv'
...
listing_final.to_csv(f'{output_dir}/CRMLSListingFinal.csv', index=False)
